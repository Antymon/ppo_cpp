...
is to read the project's `singularity/singularity.def` file and its parent.
...
7. Gregory M Kurtzer. Singularity 2.1.2 - Linux application and environment containers for science, August 2016
